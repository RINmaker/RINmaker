...
// TODO capire come disabilitare i warning di una lib esterna non nostra
...
public:
    ...
    //static std::shared_ptr<spdlog::logger> get_default();   // TODO attualmente get_default() è cout: farei in modo che punti invece ad un logger UNICO che è quello di default
