...
vector<rin::maker> rin::maker::parse_models(fs::path const& pdb_path)
{
    ifstream pdb_file;
    ...
    vector<rin::maker> rin_makers;
    for (auto const& model: models)
        rin_makers.emplace_back(pdb_name, model, ssbond_records, helix_records, sheet_records);
